...
public class SessionFilter implements Filter {
	...
	public void doFilter(ServletRequest req, ServletResponse res,
		...
		if (servletPath.equals(forwardUrl) || servletPath.endsWith(".js")
				|| servletPath.endsWith(".css") || servletPath.endsWith(".png")
				|| servletPath.endsWith(".jpg") || servletPath.endsWith(".mp3")) {
		...
		if (sessionObj == null) {
			...
			// response.getWriter().print("<script>window.top.location.href="
			// + "'http://localhost:8080/StudentManager1"
			// + forwardUrl + "';</script>");
